...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('marketplace', '0002_marketplaceitem_image'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='category',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='items', to='marketplace.marketplacecategory'),
        ),
    ]
