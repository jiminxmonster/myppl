...
def backfill_product_store_name(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("boards", "0010_post_live_broadcast_info"),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(blank=True, max_length=80, verbose_name="해당 쇼핑몰 이름"),
        ),
        migrations.RunPython(backfill_product_store_name, migrations.RunPython.noop),
    ]
